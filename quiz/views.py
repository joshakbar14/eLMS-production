    ...
    try:
        ...
        if is_teacher_authorised(request, code):
            if request.method == 'POST':
                ...
                return render(request, 'quiz/quiz.html', {'course': course, 'teacher': Teacher.objects.get(teacher_id=request.session['teacher_id'])})
    ...
    try:
        ...
        if is_teacher_authorised(request, code):
            ...
            if request.method == 'POST':
                ...
                return render(request, 'quiz/addQuestion.html', {'course': course, 'quiz': quiz, 'teacher': Teacher.objects.get(teacher_id=request.session['teacher_id'])})
    ...
    if is_teacher_authorised(request, code):
        ...
        for quiz in quizzes:
            ...
            if quiz.start < datetime.datetime.now():
                ...
                quiz.started = False
            quiz.save()
        return render(request, 'quiz/allQuizzes.html', {'course': course, 'quizzes': quizzes, 'teacher': Teacher.objects.get(teacher_id=request.session['teacher_id'])})
    else:
        return redirect('std_login')
